...
class _CustomerAddJobScreenState extends State<CustomerAddJobScreen> {
  ...
  Widget textBox(String textLabel, TextEditingController textController) {
    return SizedBox(
      height: 50,
      child: TextField(
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(children: [
            ...
            textBox("Add job title", jobTitleController),
            const SizedBox(
              height: 20,
            ),

            textBox("Add job description", jobDescController),
            const SizedBox(
              height: 20,
            ),
                    ...
                    child: DropdownButtonHideUnderline(
                      ...
                      onChanged: (String? newValue) {
                        setState(() {
                          ...
                          budgetController = budgetDropdownValue;
            ...
            //Location
            textBox("Add location", locationController),
